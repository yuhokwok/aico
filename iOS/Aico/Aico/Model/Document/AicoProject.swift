...
//  Aico
//
//  Created by Aico Team on 18/10/2023.
//

import UIKit

@Observable
class AicoProject : UIDocument {
    ...
    override var savingFileType: String? {
        return "com.417tech.app.Aico.project"
    }
    ...
    func save() {
        ...
        let fileURL = url.appendingPathComponent("project.aicoproject.aicojson")
    ...
    var projectName : String {
        return self.fileURL.lastPathComponent.replacingOccurrences(of: ".aicoproj", with: "")
    }
}
