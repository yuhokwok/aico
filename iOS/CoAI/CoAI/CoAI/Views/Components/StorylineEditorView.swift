                        ...
                        HStack (spacing: 30) {
                            ...
                            ForEach(nodes) {
                                ...
                                StorylineCell(title: stage.name,
                                              ...
                                              selected: documentHandler.project.editorState.selectedStageId == stage.identifier)
                                .onDrag({
                            ...
                            Button (action: {
                                ...
                                .overlay {
                                    Image("addScene")
                                        ...
                                        .background {
                                            Circle()
                                                .fill(LinearGradient(colors: [Color(hex: "#4CCDFF"), Color(hex: "#259EFF")],
                                                                     startPoint: UnitPoint(x: 0.5, y: 0.0), endPoint: UnitPoint(x: 0.5, y: 0.8)))
